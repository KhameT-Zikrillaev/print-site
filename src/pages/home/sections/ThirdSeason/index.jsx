...
export default function ThirdSeason() {
  ...
  <div className="w-[80%] h-[2px] mx-auto bg-gradient-to-r from-teal-500 to-blue-600 my-4"></div>
        <p className="p480:text-lg text-gray-700 leading-relaxed tracking-wide">
        ...
        <div className="flex justify-center mt-10">
          <button className="bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg shadow-md hover:bg-blue-600 transition duration-300">
            Узнать больше
          </button>
        </div>
      </div>
